...
type ResumeStorage interface {
	...
	GetPresignedUploadURL(ctx context.Context, candidateID int64, vacancyID uuid.UUID) (service_models.PresignedUploadResult, error)
}
...
func (s *Service) GetUploadURL(ctx context.Context, candidateID int64, vacancyID uuid.UUID) (service_models.PresignedUploadResult, error) {
	return s.resumeStorage.GetPresignedUploadURL(ctx, candidateID, vacancyID)
}
